...
pub const ARG_TOKEN_ID_HASH: &str = "token_id_hash";
...
pub const ENTRY_POINT_ADD_TO_ACCOUNT_WHITELIST: &str = "add_to_account_whitelist";
pub const ENTRY_POINT_REMOVE_FROM_ACCOUNT_WHITELIST: &str = "remove_from_account_whitelist";
