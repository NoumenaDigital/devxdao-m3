...
pub(crate) const ENTRY_POINT_ADD_TO_ACCOUNT_WHITELIST: &str = "add_to_account_whitelist";
pub(crate) const ENTRY_POINT_REMOVE_FROM_ACCOUNT_WHITELIST: &str = "remove_from_account_whitelist";
...
pub(crate) const ARG_TOKEN_ID_HASH: &str = "token_id_hash";
...
pub(crate) const TEST_TOKEN_ID_HASH_DATA: &str = "32862c2d-db84-4b44-83dd-97835aef3ed7";
